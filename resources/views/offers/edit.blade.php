            ...
            <form action="{{ route('offers.update', $offer->id) }}" method="post" class="" enctype="multipart/form-data">
                ...
                <div class="bg-gray-100 py-6 sm:py-12 flex justify-center align-items">
                    <div class="relative max-w-2xl w-full px-5 py-10 bg-white mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
                        <h2 class="font-semibold text-xl text-gray-700 leading-relaxed text-center">Update offer</h2>
                        <div class="divide-y divide-gray-200">
                            <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                <div class="flex flex-col">
                                    <label class="leading-loose">Title <span class="text-red-400 text-sm">(required)</span></label>
                                    <input name="title" value="{{ old('title', $offer->title) }}" type="text" required="required" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="Title">
                                    @error('title')
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <input name="price" value="{{ old('price', $offer->price) }}" type="number" min="0" required="required" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="Price">
                                    @error('price')
                                    <p class="text-red-700 p-2">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="flex flex-col image-preview">
                                    ...
                                    <div class="flex items-center justify-center p-4">
                                        <img class="w-96 h-72 object-cover rounded-3xl" src="{{ asset($offer->image_url) }}" alt="">
                                    </div>
                            ...
                            <div class="pt-4 flex items-center space-x-4">
                                <a href="{{ route('offers.index') }}" class="flex justify-center items-center w-full text-gray-900 px-4 py-3 rounded-md focus:outline-none">
